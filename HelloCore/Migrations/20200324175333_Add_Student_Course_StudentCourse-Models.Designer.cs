...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HelloCore.Models.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("HelloCore.Models.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("HelloCore.Models.StudentCourse", b =>
                {
            ...
            modelBuilder.Entity("HelloCore.Models.StudentCourse", b =>
                {
                    b.HasOne("HelloCore.Models.Course", "Course")
                        .WithMany("Students")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("HelloCore.Models.Student", "Student")
                        .WithMany("Courses")
